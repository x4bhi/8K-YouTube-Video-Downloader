...
namespace YouTubeDownloader
{
    ...
    public class DownloaderForm : Form
    {
        ...
        const string URL_PLACEHOLDER = "Paste YouTube video or playlist link...";
        ...
        private void InitializeComponent()
        {
            ...
            btnDownload.Text = "EXTRACTING COMPONENTS...";
            ...
            lblStatus = new Label();
            lblStatus.Text = "Initializing - extracting standalone components...";
        ...
        private async Task BtnAnalyze_ClickAsync()
        {
            ...
            SetUIBusy(true, "Analyzing URL formats...");
            txtLog.Clear();
            ...
            try
            {
                ...
                SetStatus($"Analysis complete - {availableVideoFormats.Count} video, {availableAudioFormats.Count} audio formats found.", C_SUCCESS);
        ...
        private async Task BtnDownload_ClickAsync()
        {
            ...
            SetStatus("Preparing download...", C_TEXT_DIM);
        ...
        {
            cts?.Cancel();
            SetStatus("Cancelling download...", C_WARN);
        }
        ...
        private async Task BtnUpdate_ClickAsync()
        {
            btnUpdate.Enabled = false;
            btnDownload.Enabled = false;
            SetStatus("Checking for yt-dlp updates...", C_TEXT_DIM);
        ...
        {
            btnAnalyze.Text = busy ? "ANALYZING..." : "ANALYZE";
